  ...
  if (windCanvas) {
    window.__chartWind = new Chart(windCanvas, {
      ...
      data: {
        labels,
        datasets: [
          // ✅ menys gruix + menys puntets
          { label: "Ratxa màxima", data: gust, tension: 0.25, pointRadius: 1, pointHoverRadius: 5, pointHitRadius: 10, borderWidth: 1.4, borderDash: [6, 4], fill: false },
          // ✅ trec el fill per evitar “xou” visual (si el vols, torna a posar fill:true)
          { label: "Vent mitjà", data: wind, tension: 0.25, pointRadius: 1, pointHoverRadius: 5, pointHitRadius: 10, borderWidth: 1.8, fill: false }
        ]
      },
